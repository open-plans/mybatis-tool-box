...
/**
 * 用途：MyBatis 性能拦截器，用于输出每条 SQL 语句及其执行时间  //第三版本
 */
@Intercepts(
	    {
	...
	public class MybatisAutoSql3 implements Interceptor {
	    ...
	    public Object intercept(Invocation invocation) throws Throwable {
	        ...
	        long start = System.currentTimeMillis();
 	        ...
 	        proceed=executor.query(ms, parameter, rowBounds, resultHandler, cacheKey, boundSql);
